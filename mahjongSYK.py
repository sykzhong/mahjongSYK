...
class Hand_in_group(object):
    ...
    def xiangtingshu(self):
        ...
        max_num_mianzi = (int)((num_cards - 1) / 3)
        for group in self.groups:
            ...
            if type_of_group in MIANZI:
                ...
                num_quetou += 1
            elif type_of_group in DAZI and num_dazi < max_num_mianzi - num_mianzi:
                num_dazi += 1
        return 2*max_num_mianzi - 2 * num_mianzi - num_quetou - num_dazi
